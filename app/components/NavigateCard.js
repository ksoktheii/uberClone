...
const GOOGLE_MAP_APIKEY = "AIzaSyBOt0uTlsT17xLdIPY5Wg640AttnhcQDZc"
...
const NavigateCard = () => {
    ...
    return (
        <Screen style={tailwind`bg-white flex-1`}>
            <Text style={tailwind`text-center pb-5 text-xl font-bold`}>Enter Destination</Text>
            ...
            <View style={tailwind`px-3 bg-white relative z-10 justify-between flex-1`}>
                ...
                <View style={tailwind`mt-3 flex-row justify-evenly py-3 border-t border-gray-100`}>
                    <TouchableOpacity
                        style={tailwind`flex-row bg-white w-24 px-4 py-3 `}
                    >
                        <Icon  color="black" size={16} />
                        <Text style={tailwind`text-black text-center pl-3`}></Text>
                    </TouchableOpacity>
                    <TouchableOpacity
